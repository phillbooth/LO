...
# Why Controllers Should Not Be Used in LogicN

When building applications using the Logic-Oriented (LogicN) framework, it's essential to follow best practices to ensure your code is secure, maintainable, and efficient. One crucial aspect of LogicN development is the use of routes, actions, policies, effects, and generated reports.
...
*   **Performance**: By compiling routes into a static route graph, LogicN applications can achieve better performance.

## Conclusion

When building LogicN applications, it's essential to follow best practices and use the recommended approach. This includes using routes, actions, policies, effects, and generated reports explicitly instead of traditional MVC Controllers. By doing so, we can ensure our code is secure, maintainable, and efficient.