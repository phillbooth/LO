...
`lo-core-compiler` is the future compiler package for LO parser, checker, IR,
...
`lo-core-compiler` should own the implementation-oriented compiler pipeline.
...
lo-core-compiler implements compiler pipeline contracts.
