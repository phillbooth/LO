...
const graph = {
  ...
  nodes: [
    createPackageNode(
      "package:lo-security",
      "lo-security",
      "packages-lo/lo-security/README.md",
    ...
    ),
    {
      ...
      kind: "Type",
      label: "SecureString",
      sourcePath: "packages-lo/lo-security/src/index.ts",
      tags: ["security", "type"],
    },
  ],
  edges: [
  ...
  it("builds a workspace graph from package files and exported contracts", () => {
    const workspaceGraph = createWorkspaceProjectGraph({
      workspace: {
        name: "LO-test",
        packages: [
          { path: "packages-lo/lo-security" },
          { path: "packages-lo/lo-project-graph" },
        ],
        docs: {
      ...
      files: [
        {
          path: "packages-lo/lo-security/package.json",
          kind: "json",
          text: JSON.stringify({
            name: "@lo/security",
        ...
        {
          path: "packages-lo/lo-security/README.md",
          kind: "markdown",
          text: "# LO Security\n\nReusable security primitives.",
        },
        {
          path: "packages-lo/lo-security/src/index.ts",
          kind: "typescript",
        ...
        },
        {
          ...
          kind: "markdown",
          text: "Security docs mention packages-lo/lo-security and lo-project-graph.",
        },
      ],
    });
