...
recommended modes and report shape live in `packages-lo/lo-benchmark/README.md`.
...
lo task generateReports --file packages-lo/lo-tasks/examples/tasks.lo --dry-run
